#ifndef LIMITERHWENO_SC_LIN_Char_H_
#define LIMITERHWENO_SC_LIN_Char_H_
...
#define HWENO_SC_LIN_Char LimiterHWENO_SC_LIN_Char

using namespace std;

class LimiterHWENO_SC_LIN_Char :
	public Limiter
{
private:
...
public:
	...
	LimiterHWENO_SC_LIN_Char(const BaseParams& prm, const Problem& prb, const Indicator& ind, double degree);

	//Деструктор
	~LimiterHWENO_SC_LIN_Char();
};
